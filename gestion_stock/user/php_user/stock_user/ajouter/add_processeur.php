...
<form action="" method="post">
    <label for="nom_processeur">Processeur :</label>
    <input type="text" name="nom_processeur" id="nom_processeur">
    <input type="submit" name="ajouter_processeur" value="Ajouter le processeur">
</form>
<?php
...
if (isset($_POST['ajouter_processeur'])) {
    $processeur = $_POST['nom_processeur'];
    $requete = "INSERT INTO processeur (processeur) VALUES ('$processeur')";
