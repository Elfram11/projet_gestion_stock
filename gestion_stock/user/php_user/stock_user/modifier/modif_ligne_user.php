...
<link rel="stylesheet" href="../../../css_user/style_header.css">
...
<form action="requete_modifier.php" method="post">
...
// affichage du modèle
echo "<br><br>Numéro de serie : <input type='text' id='nserie' name='nserie' placeholder='Modèle de l'appareil' required value='".$materiel['nserie']."'>";
