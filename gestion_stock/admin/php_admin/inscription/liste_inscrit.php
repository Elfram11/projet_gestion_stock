...
if (!$resultat) {
    ...
    <table border="2">
        ...
        while($ligne = $resultat->fetch()) {
            "<tr>";
            echo "<td>".$ligne['id']."</td>";
            echo "<td>".$ligne['compte_identifiant']."</td>";
            echo "<td>".$ligne['compte_grade']."</td>";



            echo "<tr+>" . "<td>" . "<a href='requete_supprimer.php?id=" . $ligne['id'] . "'><button>Supprimer</button></a>" . "</td>" . "</tr>";
        }
        ?>
        </tr>
        </tbody>
